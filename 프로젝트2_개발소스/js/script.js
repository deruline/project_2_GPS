...
$(function () {
  ...
  $(function Allmaneup() {
    if (menu1.css("display") == "block") menu1.slideToggle();
    if (menu2.css("display") == "block") menu2.slideToggle();
    if (menu3.css("display") == "block") menu3.slideToggle();
    if (menu4.css("display") == "block") menu4.slideToggle();
    if (menu5.css("display") == "block") menu5.slideToggle();
    if (menu6.css("display") == "block") menu6.slideToggle();
    if (menu7.css("display") == "block") menu7.slideToggle();
  });
...
// 선택한 slide로 이동
document.querySelector("#tab01").addEventListener("click", function (e) {
  // e.preventDefault();
  swiper.slideTo(3, 0);
});
document.querySelector("#tab02").addEventListener("click", function (e) {
  // e.preventDefault();
  swiper.slideTo(5, 0);
});
document.querySelector("#tab03").addEventListener("click", function (e) {
  // e.preventDefault();
  swiper.slideTo(6, 0);
});
document.querySelector("#tab04").addEventListener("click", function (e) {
  // e.preventDefault();
  swiper.slideTo(10, 0);
});
document.querySelector("#tab05").addEventListener("click", function (e) {
  // e.preventDefault();
  swiper.slideTo(15, 0);
});
document.querySelector("#tab06").addEventListener("click", function (e) {
  // e.preventDefault();
  swiper.slideTo(20, 0);
});
